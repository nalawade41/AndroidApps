...
public class DatabaseHelper extends SQLiteOpenHelper {
	...
	private static final String CREATE_TABLE_LOCATIONS = "CREATE TABLE "
			...
			+ " GeoNameID TEXT," + " LocationTypeID INTEGER," + ADDED_TIME_KEY
			+ " DATETIME" + ")";
	private static final String CREATE_TABLE_LOCATION_TYPE = "CREATE TABLE "
			+ TABLE_LOCATIONTYPES + "(" + "LocationType" + PRIMARY_KEY
			+ " INTEGER PRIMARY KEY," + " LocationType TEXT," + ADDED_TIME_KEY
			+ " DATETIME" + ")";
	private static final String CREATE_TABLE_WEATHER_DETAILS = "CREATE TABLE "
			+ TABLE_WEATHER_DETAILS + "(" + "WeatherDetails" + PRIMARY_KEY
			+ " INTEGER PRIMARY KEY," + " Location" + PRIMARY_KEY + " INTEGER,"
